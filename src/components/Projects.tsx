      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
          {projects.map((project) => (
            <motion.div
            key={project.id}
            className="bg-[#374151] rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 flex flex-col"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5 }}
            viewport={{ once: true }}
          >
            ...
            <div className="p-6 flex flex-col flex-grow">
              ...
              <p className="text-[#9CA3AF] mb-6 flex-grow">
                {project.description}
              </p>
          
              <div className="mt-auto flex gap-4 pt-4 border-t justify-between border-gray-600">
                <Link
